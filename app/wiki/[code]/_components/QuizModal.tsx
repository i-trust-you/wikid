		...
		<div className="flex flex-col">
			...
			<form className="mt-9">
				...
				<div className="relative mt-[10px]">
					<input
						className={`${isError ? "bg-red-100 outline-red-200" : "bg-gray-100"} w-full rounded-[10px] px-5 py-[10px] text-md font-normal text-gray-500 placeholder:text-gray-400`}
						value={value}
						onChange={(e) => setValue(e.target.value)}
						placeholder="답안을 입력해 주세요"
					/>
					{isError && <p className="absolute mt-[10px] text-xs font-normal text-red-200">정답이 아닙니다. 다시 시도해 주세요.</p>}
				</div>
				<div className="mt-10">
